...
My research focuses on computer vision and multimodal intelligence. My current interests include: (i) **Visual perception and restoration**. Restoring visual content and improving perception under adverse weather and complex illumination, with an emphasis on generalization to real-world conditions; (ii) **Multimodal understanding and controllable generation**. Learning across vision, language, and audio for multimodal understanding, and developing methods for fine-grained control and consistency in visual generation; and (iii) **Continual adaptation and self-evolving agents**. Studying how agents can autonomously generate tasks and training data, learn from interaction and feedback, and sustain improvement as tasks and environments change.
