...
- **Silence is Not Consensus: Disrupting Agreement Bias in Multi-Agent LLMs via Catfish Agent for Clinical Decision Making**  
  Yihan Wang^, Qiao Yan^, Zhenghao Xing^, Lihao Liu, Junjun He, Chi-Wing Fu, **Xiaowei Hu\***, and Pheng-Ann Heng  
...
- **GMAI-VL-R1: Harnessing Reinforcement Learning for Multimodal Medical Reasoning**  
  Yanzhou Su^, Tianbin Li^, Jiyao Liu, Chenglong Ma, Junzhi Ning, Cheng Tang, Sibo Ju, Jin Ye, Pengcheng Chen, Ming Hu, Shixiang Tang, Lihao Liu, Bin Fu, Wenqi Shao, **Xiaowei Hu**, Xiangwen Liao, Yuanfeng Ji, and Junjun He  
  ArXiv Tech Report, 2025  
  [arXiv](https://arxiv.org/abs/2504.01886) [project](https://github.com/uni-medical/GMAI-VL-R1)

- **MedHallTune: An Instruction-Tuning Benchmark for Mitigating Medical Hallucination in Vision-Language Models**  
  Qiao Yan, Yuchen Yuan, **Xiaowei Hu**, Yihan Wang, Jiaqi Xu, Jinpeng Li, Chi-Wing Fu, and Pheng-Ann Heng  
  ArXiv Tech Report, 2025  
